...
// encyclopedia — is an entry here plus a component; the client renders whatever this lists, in order.
...
/** How the tiling is built; shown in the title block and each switcher cell's tooltip. */
