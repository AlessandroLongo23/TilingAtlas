...
function main(): void {
	...
	// Phase 2 (buildMyersK1Stars) RETIRED 2026-07-11: a capped legacy AL-PeriodSolver gallery, fully
	// superseded by Phase 4's Čtrnáct engine (which reproduces all 23 of Myers' k=1 records exactly).
	// It only injected duplicates (e.g. 3*.12, 4*.12 already emitted as ctrnact-star-k1-03/05). Kept the
	// function for reference; no longer called.
	void buildMyersK1Stars;
