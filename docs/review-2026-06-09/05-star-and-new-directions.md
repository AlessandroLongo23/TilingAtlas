...
| ST-2 | Honest run-matrix + §24 retitle + vocabulary | major | CC | ST-1 (thesis text only), [TH-3](03-theory-obligations.md) (pool bound) | [x] CC side 2026-06-10 (NOTES §35.3; resources-contract wording → TA) |
| ST-3 | Myers-2009 k=2 oracle (crown deliverable) | major | CC+TA (AL: conjecture) | ST-1, [TH-5](03-theory-obligations.md), [TH-6](03-theory-obligations.md), [TX-3](02-thesis-alignment.md) (bib) | [~] steps 1+3 landed 2026-06-10 (NOTES §35.1; TA spot-check + step 4 AL + step 5 TX-3 open) |
...
| ST-9 | Productive star-fill validation gap | minor | CC | [CB-9](01-code-bugs.md) (commit hygiene) | [x] 2026-06-10 (NOTES §35.2 — 4(j) sub-fan impossible by construction; positive case = 4(i), widened-pool test) |
