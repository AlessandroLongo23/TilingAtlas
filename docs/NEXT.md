...
- **CC** — Sub Rosa substitution generator **SHIPPED & PARKED** (`feat/subrosa-editor`): n = 4,5,6,7,8,9,11
  (8–22-fold, odd + even), batched-WebGL2 renderer, exact ℤ[ζ₄ₙ], all self-compose gap/overlap-free. Backlog
