...
import { polygonHue, TILE_FILL_ALPHA, tileFill, type TranslationalCellData } from "@/lib/utils/renderTiling";
										...
										comp.map((c) => (
											...
											>
												<span
													...
													style={{ background: tileFill(polygonHue(c.n), TILE_FILL_ALPHA) }}
												/>
