/**
 * §34 regression (CB-4 guard discovery, 2026-06-10): `reducedClassKey` must be CLASS-CANONICAL —
...
describe('reducedClassKey class-invariance (§34)', () => {
	...
	it('tilingsCongruent is symmetric when the same tiling is encoded with different per-tile translates', () => {
		...
		// non-canonical reduction makes this fail in one direction (the §34 asymmetry mechanism).
