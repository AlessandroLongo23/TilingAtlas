...
// which is exactly backwards from the palettes (star tiles are HSB 0.50/0.98, convex ones 0.40/1.00).
// Flat white ambient was eating the saturation. Every spherical shelf is lit identically now.
