 ...
 * URL helpers are client-safe. Upload/list functions live in server-side route handlers.
 *
 * Setup required:
...
export function getPolygonsUrl(paramsFolder: string): string {
	return `${SUPABASE_URL}/storage/v1/object/public/${PIPELINE_BUCKET}/${paramsFolder}/polygons.json`;
}

/** Get public URL for vcs.json */
export function getVCsUrl(paramsFolder: string): string {
	return `${SUPABASE_URL}/storage/v1/object/public/${PIPELINE_BUCKET}/${paramsFolder}/vcs.json`;
}

/** Get public URL for compatibilityGraph.json */
export function getCompatibilityGraphUrl(paramsFolder: string): string {
	return `${SUPABASE_URL}/storage/v1/object/public/${PIPELINE_BUCKET}/${paramsFolder}/compatibilityGraph.json`;
}
...
export function getSeedConfigurationsVcLibraryUrl(paramsFolder: string): string {
	return `${SUPABASE_URL}/storage/v1/object/public/${PIPELINE_BUCKET}/${paramsFolder}/seedConfigurations/vcLibrary.json`;
}
...
export function getSeedConfigurationsManifestUrl(paramsFolder: string, k: number, m: number): string {
	return `${SUPABASE_URL}/storage/v1/object/public/${PIPELINE_BUCKET}/${paramsFolder}/seedConfigurations/k=${k}/m=${m}/manifest.json`;
}
...
export function getExpandedSeedsManifestUrl(paramsFolder: string, k: number, m: number): string {
	return `${SUPABASE_URL}/storage/v1/object/public/${PIPELINE_BUCKET}/${paramsFolder}/expandedSeeds/k=${k}/m=${m}/manifest.json`;
}
...
export function getTranslationalCellsManifestUrl(paramsFolder: string, k: number, m: number): string {
	return `${SUPABASE_URL}/storage/v1/object/public/${PIPELINE_BUCKET}/${paramsFolder}/translationalCells/k=${k}/m=${m}/manifest.json`;
}
...
export function getSeedConfigurationsBatchUrl(
	...
	return `${SUPABASE_URL}/storage/v1/object/public/${PIPELINE_BUCKET}/${paramsFolder}/seedConfigurations/k=${k}/m=${m}/${name}`;
}
...
export function getExpandedSeedsBatchUrl(
	...
	return `${SUPABASE_URL}/storage/v1/object/public/${PIPELINE_BUCKET}/${paramsFolder}/expandedSeeds/k=${k}/m=${m}/${name}`;
}
...
export function getTranslationalCellsBatchUrl(
	...
	return `${SUPABASE_URL}/storage/v1/object/public/${PIPELINE_BUCKET}/${paramsFolder}/translationalCells/k=${k}/m=${m}/${name}`;
}

/** Base URL for pipeline bucket (for path construction) */
export function getPipelineBaseUrl(): string {
	return `${SUPABASE_URL}/storage/v1/object/public/${PIPELINE_BUCKET}`;
}
