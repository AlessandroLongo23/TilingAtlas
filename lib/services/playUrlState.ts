...
export const PLAY_PARAMS: Record<string, Spec> = {
	...
	// spherical view
	sopa: { field: "sphericalFaceOpacity", kind: "num", min: 0, max: 1 },
	irigid: { field: "islamicRigid", kind: "bool" },
	ssec: { field: "islamicBarSection", kind: "enum", values: ["tube", "rect"] },
	sthk: { field: "islamicBarThickness", kind: "num", min: 0.005, max: 0.15 },
	shgt: { field: "islamicBarHeight", kind: "num", min: 0.005, max: 0.15 },
	sbev: { field: "islamicBarBevel", kind: "num", min: 0, max: 1 },
