...
export const SPH_STAR_INDEX: SphStarEntry[] = [
	{ id: "ss-48-72-26-d1", config: "8/3.6.4", k: 1, density: 1, rho: 0, solid: "great truncated cuboctahedron (U20)", stats: { verts: 48, edges: 72, faces: 26, symmetryOrder: 48, symmetryOrbits: 1, types: [[4, 1, 12], [6, 1, 8], [8, 3, 6]], densitySuspect: true } },
	...
	{ id: "ss-24-48-20-d2", config: "8.4.8.3", k: 1, density: 2, rho: 0, solid: "small cubicuboctahedron (U13)", stats: { verts: 24, edges: 48, faces: 20, symmetryOrder: 48, symmetryOrbits: 1, types: [[3, 1, 8], [4, 1, 6], [8, 1, 6]] } },
	{ id: "ss-60-120-44-d2", config: "10.5.10.3", k: 1, density: 2, rho: 0, solid: "small dodecicosidodecahedron (U33)", stats: { verts: 60, edges: 120, faces: 44, symmetryOrder: 120, symmetryOrbits: 1, types: [[3, 1, 20], [5, 1, 12], [10, 1, 12]] } },
	...
	{ id: "ss-120-180-54-d3", config: "10/3.10.4", k: 1, density: 3, rho: 0, solid: "truncated dodecadodecahedron (U59)", stats: { verts: 120, edges: 180, faces: 54, symmetryOrder: 120, symmetryOrbits: 1, types: [[4, 1, 30], [10, 1, 12], [10, 3, 12]] } },
	...
	{ id: "ss-60-120-44-d4", config: "10/3.5.10/3.3", k: 1, density: 4, rho: 0, solid: "great ditrigonal dodecicosidodecahedron (U42)", stats: { verts: 60, edges: 120, faces: 44, symmetryOrder: 120, symmetryOrbits: 1, types: [[3, 1, 20], [5, 1, 12], [10, 3, 12]] } },
	{ id: "ss-60-120-44-d4-r5894", config: "5/2.10.3.10", k: 1, density: 4, rho: 0, solid: "small ditrigonal dodecicosidodecahedron (U43)", stats: { verts: 60, edges: 120, faces: 44, symmetryOrder: 120, symmetryOrbits: 1, types: [[3, 1, 20], [5, 2, 12], [10, 1, 12]] } },
	{ id: "ss-60-120-44-d4-r7752", config: "5/2.6.5.6", k: 1, density: 4, rho: 0, solid: "icosidodecadodecahedron (U44)", stats: { verts: 60, edges: 120, faces: 44, symmetryOrder: 120, symmetryOrbits: 1, types: [[5, 1, 12], [5, 2, 12], [6, 1, 20]] } },
	...
	{ id: "ss-16-32-18-d5", config: "8/3.3.3.3", k: 1, density: 5, rho: 0, solid: "octagrammic crossed antiprism", stats: { verts: 16, edges: 32, faces: 18, symmetryOrder: 32, symmetryOrbits: 1, types: [[3, 1, 16], [8, 3, 2]] } },
	{ id: "ss-24-48-26-d5", config: "4.4.4.3", k: 1, density: 5, rho: 0, solid: "nonconvex great rhombicuboctahedron (U17)", stats: { verts: 24, edges: 48, faces: 26, symmetryOrder: 48, symmetryOrbits: 1, types: [[3, 1, 8], [4, 1, 18]] } },
	...
	{ id: "ss-60-120-52-d6", config: "6.5.6.3", k: 1, density: 6, rho: 0, solid: "great icosicosidodecahedron (U48)", stats: { verts: 60, edges: 120, faces: 52, symmetryOrder: 120, symmetryOrbits: 1, types: [[3, 1, 20], [5, 1, 12], [6, 1, 20]] } },
	...
	{ id: "ss-60-120-44-d10", config: "10/3.5/2.10/3.3", k: 1, density: 10, rho: 0, solid: "great dodecicosidodecahedron (U61)", stats: { verts: 60, edges: 120, faces: 44, symmetryOrder: 120, symmetryOrbits: 1, types: [[3, 1, 20], [5, 2, 12], [10, 3, 12]] } },
	...
	{ id: "ss-60-120-62-d13", config: "5/2.4.3.4", k: 1, density: 13, rho: 0, solid: "nonconvex great rhombicosidodecahedron (U67)", stats: { verts: 60, edges: 120, faces: 62, symmetryOrder: 120, symmetryOrbits: 1, types: [[3, 1, 20], [4, 1, 30], [5, 2, 12]] } },
	{ id: "ss-60-150-92-d13", config: "5/2.3.3.3.3", k: 1, density: 13, rho: 0, solid: "great inverted snub icosidodecahedron (U69)", stats: { verts: 60, edges: 150, faces: 92, symmetryOrder: 60, symmetryOrbits: 1, types: [[3, 1, 80], [5, 2, 12]] } },
	...
	{ id: "ss-60-150-92-d37", config: "5/2.3.3.3.3", k: 1, density: 37, rho: 0, solid: "great retrosnub icosidodecahedron (U74)", stats: { verts: 60, edges: 150, faces: 92, symmetryOrder: 60, symmetryOrbits: 1, types: [[3, 1, 80], [5, 2, 12]] } },
	{ id: "ss-60-180-112-d38", config: "5/2.3.3.3.3.3", k: 1, density: 38, rho: 0, solid: "small retrosnub icosicosidodecahedron (U72)", stats: { verts: 60, edges: 180, faces: 112, symmetryOrder: 120, symmetryOrbits: 1, types: [[3, 1, 100], [5, 2, 12]] } },
