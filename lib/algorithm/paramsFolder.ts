...
/**
 * Validates a paramsFolder string received from request bodies.
 * Only allows lowercase letters, digits, underscores, and hyphens —
 * the same characters produced by buildParamsFolderName.
 * Returns the sanitized string, or null if it looks malicious.
 */
export function validateParamsFolder(value: unknown): string | null {
